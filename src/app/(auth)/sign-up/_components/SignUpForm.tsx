...
export function SignUpForm() {
  ...
  // After successful submit, show "check your email" state
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        <input name="org_name" type="text" autoFocus placeholder="Acme Corp" className={inputCls} />
      ...
      <div>
        ...
        <input name="full_name" type="text" placeholder="Jane Smith" className={inputCls} />
